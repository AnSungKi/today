    ...
    createNode: function (nodeData, level, opts) {
      ...
      if (opts.nodeTemplate) {
        ...
        if(typeof opts.nodeContent !== 'undefined') {
          _content = '<div class="content"><span class="name">' + nodeData[opts.nodeContent] + "</span>";
          _content += typeof opts.nodeDate !== 'undefined' ? '<span class="date">' + (nodeData[opts.nodeDate] || '') + '</span>' : '';
          _content += typeof opts.nodePhoto !== 'undefined' ? '<span class="photo"><img src="' + (nodeData[opts.nodePhoto] || '') + '" alt="사진"/></span>' : '';
        }
        $nodeDiv.append('<div class="title">' + nodeData[opts.nodeTitle] + '</div>').append(_content);
      }
