...
<body>
	<div id="contents">
		<div class="mar">
			<h3>고용률 (세종 / 전국)</h3>
			<em class="top_txt_box" id="span_topEmploy"><span class="top_line">세종</span> 00년 하반기 : 00.0% (0.0% 상승<img src="images/btn_arr_up.png" alt="상승" />)</em>
			<div class="pop_wrap">
			...
			<div class="con_pop_box_02">
				<div class="con_pop_box_02_01">
					<div class="posi_re">
						<h2>검색년도</h2>
						<select name="searchyear" id="searchyear" onchange="fn_getjobEmployTableList()"></select>
